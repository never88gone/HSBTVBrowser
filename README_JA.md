...
Apple TV用ブラウザです。以前からApple TVでブラウザを使用していましたが操作性に不満があったため、自分なりに最適化を行いました。

Apple TVでTikTok、Douyin（抖音）、Tencent Video（騰訊視頻）、Youku（優酷）などの動画プラットフォームを視聴できます。対応サイトは順次追加しています。

ポリシー上の理由から、このプロジェクトはクローズドソースのままである可能性が高いです。
